...
from app.EditResultView import EditResultView
...
urlpatterns = [
    ...
    path("logout-user/", views.logout_user, name='user_logout'),
    path("admin/home/", hod_views.admin_home, name='admin_home'),
    path("staff/add/", hod_views.add_staff, name='add_staff'),
    path("course/add/", hod_views.add_course, name='add_course'),
    path("send-student-notification/", hod_views.send_student_notification, name='send_student_notification'),
    path("send-staff-notification/", hod_views.send_staff_notification, name='send_staff_notification'),
    path("add-session/", hod_views.add_session, name='add_session'),
    path("admin-notify-student/", hod_views.admin_notify_student, name='admin_notify_student'),
    path("admin-notify-staff/", hod_views.admin_notify_staff, name='admin_notify_staff'),
    path("admin-view-profile/", hod_views.admin_view_profile, name='admin_view_profile'),
    path("check-email-availability/", hod_views.check_email_availability, name="check_email_availability"),
    ...
    path('student/view/result/', student_views.student_view_result,  name='student_view-result'),
